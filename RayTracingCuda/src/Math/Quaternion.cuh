...
namespace Math
{
	...
	public:
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		__device__ __host__ Quaternion(Vector<Float,3> const & v, Float const & angle)
		{
		...
		/// \param	v	The vector.
		////////////////////////////////////////////////////////////////////////////////////////////////////
		__device__ __host__ Quaternion(Vector<Float,3> const & v)
			: m_s(0.0), m_v(v) 
		{}
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		__device__ __host__ Quaternion(Quaternion const & q)
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		__device__ __host__ Quaternion(Float const & s, Vector<Float,3> const & v)
			: m_s(s), m_v(v)
		{}
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		__device__ __host__ void setAxisAngle(Vector<Float,3> const & v, Float angle)
		{
		...
		inline __device__ __host__ __host__ Float & s()
		{ return m_s ; }

		__device__ __host__ Float s() const
		{ return m_s ; }
		...
		/// \return	.
		////////////////////////////////////////////////////////////////////////////////////////////////////
		__device__ __host__ Vector<Float,3> v() const
		{ return m_v ; }
		...
		/// \return	.
		////////////////////////////////////////////////////////////////////////////////////////////////////
		__device__ __host__ Vector<Float,3> & v()
		{ return m_v ; }
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		__device__ __host__ Quaternion operator+ (Quaternion const & q) const
		...
		/// \return	The result of the operation.
		////////////////////////////////////////////////////////////////////////////////////////////////////
		__device__ __host__ Quaternion operator* (Float const & v) const
		...
		/// \return	.
		////////////////////////////////////////////////////////////////////////////////////////////////////
		__device__ __host__ Quaternion inv() const
		{   return Quaternion(m_s, -m_v) ; }
		...
		__device__ __host__ Quaternion & operator= (Quaternion const & q)
		{
			m_s = q.m_s ;
			m_v = q.m_v ;
			return (*this) ;
		...
		/// \return	.
		////////////////////////////////////////////////////////////////////////////////////////////////////
		__device__ __host__ Quaternion rotate(Quaternion const & q) const
		{
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		__device__ __host__ Vector<Float, 3> rotate(Vector<Float, 3> const & v)
		{
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		__device__ __host__ void getAxisAngle(Vector<Float,3> & axis, Float & angle)
		{
			angle = 2*acos(m_s) ;
			if(angle != 0.0)
