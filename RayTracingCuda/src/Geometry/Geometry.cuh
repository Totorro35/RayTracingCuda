...
#include <Math/ComputeVertexNormals.cuh>
...
#include <map>
	...
	public:
		...
		////////////////////////////////////////////////////////////////////////////////////////////////////
		void rotate(Math::Quaternion<float> const & q)
		{
			for(auto it=m_vertices.begin(), end=m_vertices.end() ; it!=end ; ++it)
			{
				(*it) = q.rotate(*it).v() ;
		...
		void computeVertexNormals(float angle)
		{
			...
			Math::ComputeVertexNormals normalsComputation(triangles);
